...
func (t *WebsocketTransport) maDial(ctx context.Context, raddr ma.Multiaddr) (transport.CapableConn, error) {
	...
	return SSHMuxTransport.NewConn(mnc, false)
}

func (t *WebsocketTransport) maListen(a ma.Multiaddr) (transport.Listener, error) {
